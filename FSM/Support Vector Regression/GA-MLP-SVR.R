...
para_value_min <- c( epsilon = 0, c = 1e-4,scale = 1e-5, offset = -10 )
para_value_max <- c( epsilon = 1, c = 10,scale = 1, offset = -1e-5 )
...
modelSVM <- ksvm( 
  ...
  epsilon = 0.695876,
  C = 8.155622, 
  kpar=list(scale=0.143549,offset=-3.256704),
  cross = 10
)
modelSVM@nSV
...
write.table(prediction,file="results/Predicted_GA_MLP_SVR.csv",sep=",")
