...
# Creating the Model: "L2-ADAM-ReLU-Softmax-DNN"
...
write.table(pred1,file="results/Predicted_Classes_L2_Softmax.csv",sep=",")
...
write.table(prob1,file="results/Predicted_Scores_L2_Softmax.csv",sep=",")
