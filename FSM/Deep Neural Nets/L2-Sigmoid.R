...
# Creating the Model: "L2-ADAM-ReLU-Sigmoid-DNN"
...
write.table(pred1,file="results/Predicted_Classes_L2-Sigmoid_DNN.csv",sep=",")
...
write.table(prob1,file="results/Predicted_Scores_L2-Sigmoid_DNN.csv",sep=",")
