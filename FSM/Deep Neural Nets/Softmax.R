...
# Creating the Model: "ADAM-ReLU-Softmax-DNN"
...
write.table(pred1,file="results/Predicted_Classes_Softmax_DNN.csv",sep=",")
...
write.table(prob1,file="results/Predicted_Scores_Softmax_DNN.csv",sep=",")
