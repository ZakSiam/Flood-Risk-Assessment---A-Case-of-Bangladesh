...
# Creating the Model: "ADAM-ReLU-Sigmoid-DNN" 
...
write.table(pred1,file="results/Predicted_Classes_Sigmoid_DNN.csv",sep=",")
...
write.table(prob1,file="results/Predicted_Scores_Sigmoid_DNN.csv",sep=",")
